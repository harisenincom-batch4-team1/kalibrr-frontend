...
export const CardChangePasswordCompany = () => {
  ...
  const { state, dispatch } = useCompanySettingContext();
      ...
      <div className="bg-white px-4 md:flex gap-5">
        ...
        >
          <p className="text-sm font-medium border-b-[1px] py-4">
            Untuk mengubah kata sandi perusahaan, mohon lengkapi data berikut.
          </p>
          <div className="w-full pb-4 space-y-2 border-b-[1px]">
            <div className="w-full border-b-[1px] pb-5 relative">
              ...
              >
                Kata sandi perusahaan sekarang *
              </label>
              <input
            ...
            <div className="w-full relative">
              <label
                ...
                className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
              >
                Konfirmasi kata sandi baru perusahaan *
              </label>
              <input
