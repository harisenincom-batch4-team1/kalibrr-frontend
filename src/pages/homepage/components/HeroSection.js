...
const HeroSection = () => {
  return (
    <div className="container mx-auto bg-[#f7f9fb] rounded-lg">
      <div className="container flex flex-auto mx-auto mt-10 rounded-md">
        <div className="w-screen container flex flex-col md:w-1/2 mx-8 my-8 ">
          <div className="container ">
            <h1 className="text-5xl font-extrabold">
              Find your dream job with
              <p className="text-5xl text-[#0086ff] mt-4">Rectify</p>
            </h1>
            ...
            <form>
              <div className="flex">
                ...
                <div className="relative w-full">
                  ...
                  <button
                    type="submit"
                    className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-[#0086ff] rounded-r-lg border border-[#0086ff] hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    <svg
                      aria-hidden="true"
                      className="w-5 h-5"
