      ...
      <div className="bg-white px-4 md:flex gap-5">
        <div className="space-y-3 pb-5 md:mt-0 w-full">
          <p className="font-normal md:font-medium border-b-2 py-4">
            Hapus akun bersifat permanen. Semua data perusahaan akan dihapus. Perusahaan harus membuat akun Kalibrr baru dan
            mengisi semua informasi yang diperlukan jika ingin membuat lowongan pekerjaan.
          </p>
