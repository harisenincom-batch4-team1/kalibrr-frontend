      ...
      <div className="container border rounded-lg mx-auto mt-6">
        ...
        <div className="flex flex-col mx-auto my-6 w-full text-[#3d464d]">
          <div className="flex flex-row justify-between">
            <div className="">
              <div className="mx-6">
                <h1 className="text-4xl font-mono font-bold">Company Name</h1>
              </div>
              <div className="mt-4 mx-6">
                <h1 className="text-2xl font-mono font-thin text-gray-700">
                  Verified Company
                </h1>
              </div>
              <div className="mt-4 mx-6">
              ...
              <div className="mt-4 mx-6 w-full text-lg text-gray-700">
                <p>
                  No. 2, Jalan Dr.Ide Anak Agung Gde Agung Kav. E 4.2,
                  RT.5/RW.2, Kuningan, Kuningan Tim., Kecamatan Setiabudi, Kota
            ...
            <div className="">
              ...
              <div className="max-w-sm mx-6 text-center">
                <a
                  href="/"
                  className="w-fit text-center text-blue-600 hover:underline"
                >
                  Report this company
                </a>
              </div>
