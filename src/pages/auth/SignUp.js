  ...
  return (
    <div className="flex flex-col gap-20 bg-stone-100 h-full">
      ...
      <div className="flex flex-row gap-[57px]">
        ...
        <div className="flex flex-col gap-7 w-96 px-5 py-5 ml-44 bg-white">
          ...
          <div className="w-fit text-base mx-auto">
            <p>
              Buat akun{" "}
              <text className="italic font-semibold">pencari kerja</text>
            </p>
          </div>

          <Link to="/user/register" className="mx-auto">
            <button
              className="bg-blue-600 text-white py-2 w-72 rounded hover:bg-blue-300 hover:text-blue-700"
              type="button"
            >
          ...
          <div className="w-fit text-sm mx-5 mb-5">
            <text>
              Anda juga dapat mendaftar menggunakan{" "}
        ...
        <div className="flex flex-col gap-7 w-96 px-5 py-5 bg-white">
          ...
          <div className="w-fit text-base mx-auto">
            <p>
              Buat akun <text className="italic font-semibold">perusahaan</text>
            </p>
          </div>

          <Link to="/company/register" className="mx-auto">
            <button
              className="bg-green-400 text-white py-2 w-60 rounded mx-auto hover:bg-blue-300 hover:text-blue-700"
              type="submit"
            >
      ...
      <div className="flex flex-col gap-3 h-fit items-center mx-auto">
        ...
        <p className="text-xs mb-28">
          Dengan membuat akun Kalibrr, Anda setuju dengan Syarat dan Ketentuan,
          Kebijakan Privasi, dan persetujuan pengguna kami.
        </p>
      </div>
    </div>
  );
