          ...
          <div className="footer-widget">
            <div className="rowflex">
              <div className="info">
                <div className="txt">
                  <p>
                    We transform the way candidates find jobs and companies hire
                    talent.
                  </p>
                </div>
                <div className="app">
              ...
              <div className="holder">
                <div className="widget">
                  ...
                  <ul id="menu-candidates-en" className="menu">
                    ...
                    >
                      <a href="https://www.kalibrr.com/job-board/1">
                        Job Board
                      </a>
                    </li>
                  </ul>
                ...
                <div className="widget">
                  ...
                  <ul id="menu-employers-en" className="menu">
                    ...
                    >
                      <a href="https://www.kalibrr.com/employers/hiring/">
                        Start Hiring
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a href="https://employerbranding.kalibrr.com/">
                        Employer Branding
                      </a>
                    </li>
                    <li
                ...
                <div className="widget">
                  ...
                  <ul id="menu-about-en" className="menu">
                    ...
                    >
                      <a href="https://www.kalibrr.com/job-board/c/kalibrr-ph/1">
                        Careers
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a href="https://www.kalibrr.com/contactus?user_ref=www.kalibrr.com_organic_job-board__c__kalibrr-ph__1">
                        Contact Us
                      </a>
                    </li>
                  </ul>
